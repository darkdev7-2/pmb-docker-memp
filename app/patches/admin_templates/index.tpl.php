...
$ministeres_logos_html = "
<div id='ministeres_logos' style='text-align:center;padding:14px 8px 10px;background:#fff;border-bottom:2px solid #e0e0e0;'>
    <img src='./opac_css/images/site/logo_memp.png' alt='Minist&egrave;re des Enseignements Maternel et Primaire' title='Minist&egrave;re des Enseignements Maternel et Primaire' style='max-height:70px;max-width:46%;margin:0 8px;vertical-align:middle;' />
    <img src='./opac_css/images/site/logo_secondaire.png' alt='Minist&egrave;re des Enseignements Secondaire, Technique et de la Formation Professionnelle' title='Minist&egrave;re des Enseignements Secondaire, Technique et de la Formation Professionnelle' style='max-height:70px;max-width:46%;margin:0 8px;vertical-align:middle;' />
</div>
";
