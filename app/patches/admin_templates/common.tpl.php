...
";
      ...
      $menu_bar = "
<div id='ministeres_logos' style='text-align:center;padding:8px 6px;background:#fff;border-bottom:2px solid #e0e0e0;'>
    <img src='".$base_path."/opac_css/images/site/logo_memp.png' alt='Minist&egrave;re des Enseignements Maternel et Primaire' title='Minist&egrave;re des Enseignements Maternel et Primaire' style='max-height:55px;max-width:46%;margin:0 6px;vertical-align:middle;' />
    <img src='".$base_path."/opac_css/images/site/logo_secondaire.png' alt='Minist&egrave;re des Enseignements Secondaire, Technique et de la Formation Professionnelle' title='Minist&egrave;re des Enseignements Secondaire, Technique et de la Formation Professionnelle' style='max-height:55px;max-width:46%;margin:0 6px;vertical-align:middle;' />
</div>
".list_modules_ui::get_instance()->get_display();
